	...
	public class MyListener implements View.OnClickListener{
		...
		public void onClick(View v){
			...
			case R.id.btn1:
			    ...
			    break;
            case R.id.btn2:
            	Intent intent2 = new Intent(Zhuye.this,Yggl.class);
				startActivity(intent2);
			    break;
            case R.id.btn3:
            	Intent intent3 = new Intent(Zhuye.this,Gzgl.class);
				startActivity(intent3);
			    break;
            case R.id.btn4:
            	Intent intent4 = new Intent(Zhuye.this,Bmgl.class);
            ...
            case R.id.btn5:
                ...
                break;
            case R.id.btn6:
            	Intent intent6 = new Intent(Zhuye.this,Ygdd.class);
            ...
            case R.id.btn7:
                ...
                break;
			case R.id.btn8:
				Intent intent8 = new Intent(Zhuye.this,Yhgl.class);
